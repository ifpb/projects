...
$comando = "ps aux | grep $processo";

$busca = shell_exec($comando);

$ps = ps_encode3($busca);

$buscaresult = json_encode($ps);

$file = fopen('../JSON/buscaprocess.json','w+') or die("File not found");
fwrite($file, $buscaresult);
fclose($file);
      ...
      <div class="row justify-content-center">
        ...
        <section class="card">
          ...
          <main class="card-body">
            ...
            <table id="top-process" class="table probusca">
              <thead>
                <tr>
                  <th>PID</th>
                  <th>USER</th>
